...
import cl.tenpo.utility.payments.job.Job;
import cl.tenpo.utility.payments.job.JobService;
import cl.tenpo.utility.payments.nats.NatsService;
import cl.tenpo.utility.payments.transaction.Transaction;
import cl.tenpo.utility.payments.transaction.TransactionService;
			...
			case 101: case 106: case 107: case 109:
				...
				transactionTemplate.execute(new TransactionCallbackWithoutResult() {
					...
					protected void doInTransactionWithoutResult(final TransactionStatus status) {
						...
						final String subject = properties.natsSubjectTransferenciaPaymentApproved;
						final byte[] data = transaction.getPublicId().getBytes();
